...
namespace WestWindConsole.Entities
{
    ...
    [Table("Categories")] // This is called an "attribute" of the class. It adds extra information about the name of the database table that the Category clas "maps to".
